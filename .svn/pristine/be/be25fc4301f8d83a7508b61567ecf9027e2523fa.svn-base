define(function (require, exports, module) {
    ...
    var btn_group_add_model = function () {
        $(document).on('click', '[data-link="/admin/group_add"]', function (e) {
            group_add_model();
        })
    }
    ...
    var ajax_get_group_delete_all = function () {
        $(document).on('click', '[data-link="/admin/group_delete"]:not(".del")', function (e) {
    ...
    var get_search_data = function () {
        $(document).on('click', '.search-button', function () {
            siteFun.search_data(siteCfg.REQUEST_URL.GROUP_LIST, 1000, get_table_data);
        })
    }
