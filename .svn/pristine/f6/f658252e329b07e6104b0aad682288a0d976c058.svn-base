define(function (require, exports, module) {
    ...
    var ajax_get_group_list = function () {
        $(document).on('click', '[data-link="/admin/admin_add"]', function () {
    ...
    var ajax_get_admin_delete_all = function () {
        $(document).on('click', '[data-link="/admin/admin_delete"]:not(".del")', function (e) {
    ...
    var get_search_data = function () {
        $(document).on('click', '.search-button', function () {
            siteFun.search_data(siteCfg.REQUEST_URL.ADMIN_LIST, 1000, get_table_data);
        })
    }
    module.exports = pub;
})
