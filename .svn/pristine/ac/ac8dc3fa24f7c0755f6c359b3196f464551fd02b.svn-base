define(function (require, exports, module) {
    ...
    var btn_goods_add_modal = function () {
        $(document).on('click', '[data-link="/i7391_CMS/goods/goods_add"]', function () {
            goods_add_modal();
        })
    }
    ...
    var ajax_get_goods_delete_all = function () {
        $(document).on('click', '[data-link="/i7391_CMS/goods/goods_detele"]:not(".del")', function (e) {
    ...
    var get_search_data = function () {
        $(document).on('click', '.search-button', function () {
            siteFun.search_data(siteCfg.REQUEST_URL.GOODS_LIST, 1000, get_table_data);
        })
    }
