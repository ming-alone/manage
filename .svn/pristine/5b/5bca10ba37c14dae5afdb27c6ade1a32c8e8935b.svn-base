define(function(require, exports, module) {
    ...
    var btn_goods_pc_add_modal = function() {
        $(document).on('click', '[data-link="/i7391_CMS/goods_pc/goods_add"]', function() {
            goods_pc_add_modal();
        })
    }
    ...
    var ajax_get_goods_pc_delete_all = function() {
        $(document).on('click', '[data-link="/i7391_CMS/goods_pc/goods_detele"]:not(".del")', function(e) {
    ...
    var get_search_data = function() {
        $(document).on('click', '.search-button', function() {
            siteFun.search_data(siteCfg.REQUEST_URL.GOODS_PC_LIST, 1000, get_table_data);
        })
    }
