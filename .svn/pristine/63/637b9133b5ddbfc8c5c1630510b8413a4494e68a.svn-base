define(function (require, exports, module) {
    ...
    var btn_pointcard_add_modal = function () {
        $(document).on('click', '[data-link="/i7391_CMS/pointcard/pointcard_add"]', function () {
            pointcard_add_modal();
        })
    }
    ...
    var ajax_get_pointcard_delete_all = function () {
        $(document).on('click', '[data-link="/i7391_CMS/pointcard/pointcard_delete"]:not(".del")', function (e) {
    ...
    var get_search_data = function () {
        $(document).on('click', '.search-button', function () {
            siteFun.search_data(siteCfg.REQUEST_URL.POINTCARD_LIST, 1000, get_table_data);
        })
    }
