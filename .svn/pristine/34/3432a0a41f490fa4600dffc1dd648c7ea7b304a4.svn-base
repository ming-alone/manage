define(function (require, exports, module) {
    ...
    $(document).on('click', '.datagrid-row:not(".datagrid-row-head")', function () {
        var status = $(this).find('.che').prop('checked');
        // console.log($(this).find('.che').prop('checked'));
    ...
    $(document).on('click', '.datagrid-row-head', function () {
        var status = $(this).find('#checkAll').prop('checked');
        console.log(status);
        $('.che').prop('checked', status);
    ...
    $(document).on('input porpertychange', 'input[type="text"]', function (e) {
